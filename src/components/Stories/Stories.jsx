...
export default function StoriesList() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>قصص الأعشاب وفوائدها | عشبة شفاء</title>
        <meta
          name="description"
          content="اكتشف قصص وأسرار الأعشاب الطبيعية: تاريخها، فوائدها العلاجية، واستخداماتها المتنوعة عبر منصة عشبة شفاء."
        />
        <meta
          name="keywords"
          content="قصص الأعشاب, فوائد الأعشاب, تاريخ الأعشاب, استخدام الأعشاب, الطب الطبيعي"
        />

        <meta property="og:title" content="قصص الأعشاب وفوائدها | عشبة شفاء" />
        <meta
          property="og:description"
          content="تعرف على القصص والأسرار الكامنة خلف الأعشاب الطبيعية وفوائدها العلاجية."
        />
