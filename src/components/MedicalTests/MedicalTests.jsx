...
export default function MedicalTests() {
  ...
  return (
    <>
      <Helmet>
        <title>الفحوصات الطبية | عشبة شفاء</title>
        <meta
          name="description"
          content="تعرف على أهم الفحوصات الطبية والتحاليل التي تساعدك على متابعة صحتك وفهم احتياجات جسمك بشكل أفضل."
        />
        <meta
          name="keywords"
          content="عشبة شفاء, فحوصات طبية, تحاليل طبية, صحة, طب بديل, تشخيص, وقاية"
        />

        <meta property="og:title" content="الفحوصات الطبية | عشبة شفاء" />
        <meta
          property="og:description"
          content="موسوعة شاملة لأهم التحاليل والفحوصات الطبية لفهم صحتك ومتابعتها."
        />
